                    ...
                    <div className="row">
                        ...
                        <div className="col-md-6 text-md-right text-center">
                            <div className="topbar-right gap-2">
                               <Link className="text-white mx-1" href={config.siteLoginUrl}> <i className="fa fa-user" />Login</Link>
                                <Link className="text-white mx-1" href={config.siteRegisterUrl}><i className="fa fa-user-plus" />Register</Link>
